function fullAvatarEditor() {
	...
	var file			= entire.ctxPath+'static/js/plugins/fullavatareditor/scripts/fullAvatarEditor.swf';		//flash文件的路径
	var	version			= "10.1.0";						//播放该flash所需的最低版本
	var	expressInstall	= entire.ctxPath+'static/js/plugins/fullavatareditor/scripts/expressInstall.swf';			//expressInstall.swf的路径
