$(function() {
    ...
    $(".homepage-header").vegas({
        ...
        delay: 1e4,
        slides: [{
            src: "/static/img/welcome/1.jpg",
            color: "#DBC9B3",
            transition: "fade2",
            transitionDuration: 1e4
        },
        {
            src: "/static/img/welcome/2.jpg",
            color: "#F6B700",
            transition: "zoomOut",
            transitionDuration: 8e3
        },
        {
            src: "/static/img/welcome/3.jpg",
            color: "#C47F48",
            transition: "swirlRight"
        },
        {
            src: "/static/img/welcome/4.jpg",
            color: "#EFAF41",
            animation: "random"
        },
        {
            src: "/static/img/welcome/5.jpg",
            color: "#CBC2B9",
            animation: "kenburns",
            transition: "swirlLeft2"
        },
        {
            src: "/static/img/welcome/6.jpg",
            color: "#ECA24D",
            animation: "random"
        }],
        walk: function(s, e) {
